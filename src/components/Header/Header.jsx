...
const Header = () => {
    ...
    return (
        <nav className='flex justify-between flex-wrap items-center my-1 mb-56 absolute md:mx-auto md:px-32 px-6 w-full'>
            ...
            <button onClick={navHandler} className=' text-3xl lg:hidden'>{open ? <XMarkIcon className='w-9 h-9 text-sky-300'></XMarkIcon> : <Bars3Icon className='w-9 h-9 text-sky-300'></Bars3Icon>}</button>

            <div className={`${open? '': 'hidden'} lg:hidden absolute top-20 bg-sky-400 rounded-md px-6 py-7`}>
